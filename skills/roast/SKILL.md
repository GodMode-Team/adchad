---
name: roast
description: Roast a chosen ad in AdChad's voice and publish it — the savage X post + the cold email. The voice is Grok (the team's prompt); you operate the publish.
version: 3.0.0-grok
metadata:
  hermes:
    tags: [marketing]
