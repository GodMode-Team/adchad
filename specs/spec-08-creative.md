...
**Goal:** Generate a real, ready-to-run static ad image from the fix copy, so the $5/$12 deliverable is a *creative*, not just text. (the team's "nano-banana statics.")
