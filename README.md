...
- [ ] **Swap roast engine to Grok** — paste the team's extracted prompt into `skills/roast/SKILL.md`, set `MODEL_ROAST=x-ai/grok-4.3`, re-run `scripts/roast-bakeoff.ts`
- [ ] **One real demo run** — flip the loop to `dryRun:false` (real public roasts + real emails) — **needs the team's explicit go**
...
2. **the team's Grok prompt** → swap the roast engine
